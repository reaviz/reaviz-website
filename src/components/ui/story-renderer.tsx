    ...
    <div className="story-container story-preview light:border-gray-200 mt-5 mb-4 rounded-sm border border-gray-800">
      ...
      <div className="flex w-full justify-end">
        <div className="-mt-6 flex items-center gap-0">
          ...
          <button onClick={() => setTheme(resolvedTheme === 'light' ? 'dark' : 'light')} className="whitespace-no-wrap border-primary inline-flex cursor-pointer items-center justify-center rounded-xs border-0 !bg-black px-2 py-1 font-sans text-xs font-semibold !text-white select-none disabled:cursor-not-allowed disabled:text-gray-400 data-[variant=filled]:disabled:bg-gray-600">
            Toggle Theme
          </button>
          {storybookKey && (
            <Link
