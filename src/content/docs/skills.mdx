...
The simplest way to install Reaviz skills is with the [`skills`](https://www.npmjs.com/package/skills) CLI — run it from your project root:
...
You can also browse and grab the skill from the [Skills Marketplace](https://skillsmp.com/skills/reaviz-skills-reaviz-skill-md).
